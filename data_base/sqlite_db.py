...
def sql_start():
    ...
    base.execute('CREATE TABLE IF NOT EXISTS Users(FirstName TEXT, LastName TEXT PRIMARY KEY, Phone TEXT, Country TEXT, City TEXT, ProgramName TEXT, UserId INTEGER)')
    base.commit()

def banner():
    test_values = [
        ["Фамилия", "Имя", "Номер телефона", "Страна", "Город", "Программа", "Ид пользователя"],
    ]
    #testList = list()
